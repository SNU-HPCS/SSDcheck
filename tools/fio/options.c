...
struct fio_option fio_options[FIO_MAX_OPTS] = {
	...
	{
		.name	= "disable_prediction",
		.lname	= "Disable prediction",
		.type	= FIO_OPT_BOOL,
		.off1	= td_var_offset(disable_prediction),
		.help	= "Disable prediction",
		.parent	= "gtod_reduce",
		.hide	= 1,
		.def	= "0",
		.category = FIO_OPT_C_STAT,
    ...
    // fixed by JS
    {
        ...
        .alias  = "bitidx_1",
        .type   = FIO_OPT_INT,
        .off1   = td_var_offset(bitidx_1),
        .minval = 0,    // 0 would be ignored
        .help   = "Index of target bit 1",
        .def    = "0",
        .hide   = 1,
        .interval = 1,
        .category = FIO_OPT_C_IO,
    ...
    },
    {
        ...
        .alias  = "bitidx_2",
        .type   = FIO_OPT_INT,
        .off1   = td_var_offset(bitidx_2),
        .minval = 0,    // 0 would be ignored
        .help   = "Index of target bit 2",
        .def    = "0",
        .hide   = 1,
        .interval = 1,
        .category = FIO_OPT_C_IO,
    ...
    },
    {
        ...
        .alias  = "bitidx_3",
        .type   = FIO_OPT_INT,
        .off1   = td_var_offset(bitidx_3),
        .minval = 0,    // 0 would be ignored
        .help   = "Index of target bit 3",
        .def    = "0",
        .hide   = 1,
        .interval = 1,
        .category = FIO_OPT_C_IO,
    ...
    },
    {
        ...
        .alias  = "bitidx_4",
        .type   = FIO_OPT_INT,
        .off1   = td_var_offset(bitidx_4),
        .minval = 0,    // 0 would be ignored
        .help   = "Index of target bit 4",
        .def    = "0",
        .hide   = 1,
        .interval = 1,
        .category = FIO_OPT_C_IO,
    ...
    {
        .name   = "bitidx_1_value",
        .lname  = "Bit index value for bitidx 1",
        .type   = FIO_OPT_STR_VAL,
        .off1   = td_var_offset(bitidx_1_value),
        .help   = "This value is used for bitengine (fix, flip)",
        .def    = "0",
        .hide   = 1,
        .interval = 1,
        .category = FIO_OPT_C_IO,
    ...
    {
        .name   = "bitidx_2_value",
        .lname  = "Bit index value for bitidx 2",
        .type   = FIO_OPT_STR_VAL,
        .off1   = td_var_offset(bitidx_2_value),
        .help   = "This value is used for bitengine (fix, flip)",
        .def    = "0",
        .hide   = 1,
        .interval = 1,
    ...
    {
        .name   = "bitidx_3_value",
        .lname  = "Bit index value for bitidx 3",
        .type   = FIO_OPT_STR_VAL,
        .off1   = td_var_offset(bitidx_3_value),
        .help   = "This value is used for bitengine (fix, flip)",
        .def    = "0",
        .hide   = 1,
        .interval = 1,
    ...
    {
        .name   = "bitidx_4_value",
        .lname  = "Bit index value for bitidx 4",
        .type   = FIO_OPT_STR_VAL,
        .off1   = td_var_offset(bitidx_4_value),
        .help   = "This value is used for bitengine (fix, flip)",
        .def    = "0",
        .hide   = 1,
        .interval = 1,
    ...
    },
    {
        ...
        .lname  = "Bit Engine",
        .type   = FIO_OPT_STR_STORE,
        .off1   = td_var_offset(bitengine),
        .help   = "Bit engine to use",
        .def    = NULL,
        .category = FIO_OPT_C_IO,
        .group  = FIO_OPT_G_IO_BASIC,
        .posval = {
            {
                .ival = "fix",
                .help = "Fix the target bit index as given value",
            },
            {
                .ival = "flip",
                .help = "Flip the target bit index as given value",
            },
        },
    },
