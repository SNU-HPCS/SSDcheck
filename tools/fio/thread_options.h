...
struct thread_options {
    ...
    unsigned int devid;
    unsigned int disable_prediction;
    ...
    unsigned int bitidx_1; // bitidx_1
    unsigned int bitidx_2; // bitidx_2
    unsigned int bitidx_3; // bitidx_3
    unsigned int bitidx_4; // bitidx_4

    unsigned long long bitidx_1_value; // value for bitidx_1
    unsigned long long bitidx_2_value; // value for bitidx_2
    unsigned long long bitidx_3_value; // value for bitidx_3
    unsigned long long bitidx_4_value; // value for bitidx_4

    char *bitengine;    // fix, flip
};
...
struct thread_options_pack {
    ...
    uint32_t bitidx_1;                    // bitidx_1
    uint32_t bitidx_2;                    // bitidx_2
    uint32_t bitidx_3;                    // bitidx_3
    uint32_t bitidx_4;                    // bitidx_4

    uint64_t bitidx_1_value;              // value for bitidx_1
    uint64_t bitidx_2_value;              // value for bitidx_2
    uint64_t bitidx_3_value;              // value for bitidx_3
    uint64_t bitidx_4_value;              // value for bitidx_4

    uint8_t bitengine[FIO_TOP_STR_MAX]; // fix, flip
